...
if (foundForbidden.length > 0) {
  console.error(`❌ Forbidden legacy dependencies found: ${foundForbidden.join(', ')}`);
  process.exit(1);
}
...
console.log("✅ Astro SSR, Tailwind Vite plugin, and Storyblok integration configured correctly.");
